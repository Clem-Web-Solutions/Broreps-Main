                    ...
                    {(() => {
                        ...
                        const detectType = (name: string): { icon: string; label: string; order: number } => {
                            ...
                            if (n.includes('follower') || n.includes('abonne') || n.includes('subscriber') || n.includes('member'))
                                ...
                                return { icon: '👥', label: 'Abonnés', order: 1 };

                            if (n.includes('like') || n.includes('jaime'))

                                return { icon: '❤️', label: 'Likes', order: 2 };

                            if (n.includes('view') || n.includes('vue'))

                                return { icon: '👁', label: 'Vues', order: 3 };

                            if (n.includes('share') || n.includes('partage'))

                                return { icon: '↗️', label: 'Partages', order: 4 };

                            if (n.includes('save') || n.includes('favorite') || n.includes('favori') || n.includes('bookmark'))

                                return { icon: '🔖', label: 'Favoris', order: 5 };

                            return { icon: '⚡', label: 'Service', order: 6 };
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2.5">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[#A1A1AA] text-[11px] mt-0.5">Sélectionne un service pour commander en un clic</p>
                                ...
                                {showPresets && (
                                    ...
                                    platformGroups.length === 0 ? (
                                        ...
                                        <div className="text-center py-8 text-[#A1A1AA] text-[13px]">
                                            ...
                                            Aucun service enregistré — activez des services dans Config → Catalogue.
                                                                        ...
                                                                        <div className="min-w-0 flex-1">
                                                                            ...
                                                                            <div className="flex items-center gap-1.5 mt-0.5">
                                                                                ...
                                                                                {svc.delivery_mode === 'dripfeed' && (
                                                                                    ...
                                                                                    <span className="text-[10px] font-semibold px-1.5 py-px rounded-md bg-blue-500/10 text-blue-400 border border-blue-500/15">💧 Drip</span>
